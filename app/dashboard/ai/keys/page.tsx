    ...
    <div className="max-w-5xl mx-auto px-4 pt-24 sm:pt-28 pb-8">
      ...
      <div className="bg-white border border-purple-100 rounded-2xl p-6 mb-6">
        ...
        <ul className="space-y-2 text-sm text-gray-600 list-disc pl-5">
          <li>
            <span className="font-medium text-gray-900">Пишет и публикует уроки:</span> агент берёт
            темы из вашего «Плана тем», создаёт текстовые уроки и публикует их по расписанию
            (не больше 3 в сутки). Уроки, не прошедшие проверку платформы, остаются черновиками —
            вы дорабатываете их в кабинете.
          </li>
          <li>
            <span className="font-medium text-gray-900">Работает только с вашим:</span> ключ
            действует от вашего имени — чужие уроки и данные агенту недоступны. Готовое
            файл-задание для агента — <b>«Инструкция для агента»</b> на хабе «Управление с ИИ».
          </li>
        </ul>
      </div>
