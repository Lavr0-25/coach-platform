...
export default function NotFound() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4 pt-24 pb-16">
      <div className="style-card p-8 sm:p-12 text-center max-w-lg w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="gradient-btn text-white px-6 py-3 rounded-xl font-semibold shadow-lg shadow-purple-500/30 transition-all"
          >
            На главную
          </Link>
          <Link
