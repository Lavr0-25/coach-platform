                      ...
                      <div className="mt-3 p-3 bg-purple-50 border border-purple-200 rounded-xl">
                        {!comment.parent_id && (
                          <div className="mb-3">
                            ...
                            <div className="flex gap-0.5">
                              {[1, 2, 3, 4, 5].map((star) => (
                                <button key={star} type="button" onClick={() => setEditRating(star === editRating ? null : star)} className="cursor-pointer hover:scale-110 transition-transform focus:outline-none">
