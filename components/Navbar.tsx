                    ...
                    {showProfileMenu && (
                      <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-y-auto messages-scrollbar max-h-[calc(100vh-80px)]">
                        ...
                        <div className="py-2">
                          ...
                          >
                            <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m3 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1120 9z" />
                            </svg>
                            API-ключи агента
                          </Link>
